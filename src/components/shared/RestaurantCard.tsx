...
export default function RestaurantCard({
  ...
  return (
    <Link href={`/resto/${restaurant.id}`}>
      {/* Card container */}
      <div className="flex flex-row items-center gap-3 p-4 h-[152px] bg-white rounded-[--radius-2xl] shadow-[0px_0px_20px_rgba(203,202,202,0.25)] hover:shadow-lg transition-shadow group">
        {/* Thumbnail */}
